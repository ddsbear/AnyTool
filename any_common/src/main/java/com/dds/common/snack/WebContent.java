...
public class WebContent {
    ...
    @Nullable
    ServiceConnection preload(final Context context, final Uri uri,
                              final @Nullable OnSessionReadyListener listener) {
    ...
    public static boolean view(final Context context, final Uri uri,
                               final @Nullable CustomTabsSession session,
                               final @Nullable Bundle activity_options) {
