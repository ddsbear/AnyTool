...
public class StateMachine {
    ...
    private static class SmHandler extends Handler {
        ...
        public final void handleMessage(Message msg) {
            if (!mHasQuit) {
                ...
                if (mDbg && mSm != null) mSm.log("handleMessage: E msg.what=" + mSm.getWhatToString(msg.what));
        ...
        private final State processMsg(Message msg) {
            ...
            if (isQuit(msg)) {
                ...
                while (curStateInfo != null && !curStateInfo.state.processMessage(msg)) {
                    /**
                     * Not processed
                     */
                    curStateInfo = curStateInfo.parentStateInfo;
                    if (curStateInfo == null && mSm != null) {
                        /**
        ...
        private final void invokeEnterMethods(int stateStackEnteringIndex) {
            for (int i = stateStackEnteringIndex; i <= mStateStackTopIndex; i++) {
                ...
                if (mDbg && mSm != null) mSm.log("invokeEnterMethods: " + mStateStack[i].state.getName());
        ...
        private void removeState(State state) {
            ...
            Collection<StateInfo> values = mStateInfo.values();
            for (StateInfo next : values) {
                if (stateInfo == next) {
                    isParent = true;
                    break;
                }
    ...
    public final int getLogRecMaxSize() {
        ...
        SmHandler smh = mSmHandler;
        if (smh == null) return 0;
        return smh.mLogRecords.maxSize();
    }
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        pw.println("curState=" + (curState == null ? "(null)" : curState.getName()));
    }
    ...
    public String toString() {
        ...
        try {
            name = mName;
            IState curState = mSmHandler.getCurrentState();
            state = curState == null ? "(null)" : curState.getName();
