...
import com.utils.library.file.FileUtils;
...
public class AppUtils {
    ...
    public static void installApp(Context context, File file) {
        ...
        startInstallPermissionSettingActivity(context, -1);
     ...
     *
     * @param context 上下文
     * @return 应用签名的MD5字符串, 比如：
     */
    public static byte[] getAppSignatureMD5(Context context) {
        Signature[] signature = getAppSignature(context, context.getPackageName());
        if (signature == null) return null;
        return EncryptUtils.encryptMD5(signature[0].toByteArray());
    }
     ...
     * @return 应用签名的MD5字符串, 比如：
     */
    public static byte[] getAppSignatureMD5(Context context, String packageName) {
        Signature[] signature = getAppSignature(context, packageName);
        if (signature == null) return null;
        return EncryptUtils.encryptMD5(signature[0].toByteArray());
    }
    ...
    /**
     * 获取应用签名的的MD5值HexString
     *
     * @param context 上下文
     * @return 应用签名的MD5字符串, 比如：
     */
    public static String getAppSignatureMD5HexString(Context context) {
        Signature[] signature = getAppSignature(context, context.getPackageName());
        if (signature == null) return null;
     ...
     * @return 应用签名的MD5字符串, 比如：
     */
    public static String getAppSignatureMD5HexString(Context context, String packageName) {
        Signature[] signature = getAppSignature(context, packageName);
        if (signature == null) return null;
        return EncryptUtils.encryptMD5ToString(signature[0].toByteArray());
    }
