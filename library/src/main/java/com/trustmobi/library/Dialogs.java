...
public class Dialogs {
    ...
    Builder buildAlert(final Activity activity, final @StringRes int title, final @StringRes int message) {
        return buildAlert(activity, title != 0 ? activity.getText(title) : null, message != 0 ? activity.getText(message) : null);
    }

    public static @CheckResult
    Builder buildAlert(final Activity activity, final @Nullable CharSequence title, final @Nullable CharSequence message) {
    ...
    public static class Builder extends AlertDialog.Builder {
        ...
        public @CheckResult
        Builder withOkButton(final @Nullable Runnable task) {
    ...
    public static @CheckResult
    FluentProgressDialog buildProgress(final Activity activity, final CharSequence message) {
    ...
    public static class FluentProgressDialog extends ProgressDialog {
        ...
        FluentProgressDialog(final Context context) {
            super(context, android.R.style.Theme_Material_Light_Dialog_Alert);
        }

        public FluentProgressDialog indeterminate() {
            setIndeterminate(true);
            return this;
        }

        public FluentProgressDialog nonCancelable() {
            setCancelable(false);
            return this;
        }
