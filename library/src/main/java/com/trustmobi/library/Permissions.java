...
public class Permissions {
    ...
    public static class PermissionRequestFragment extends Fragment {
        ...
        public PermissionRequestFragment(final String permission, final Consumer<Integer> callback) {
        ...
        @Override
        public void onRequestPermissionsResult(final int request, final String[] permissions, @NonNull final int[] results) {
