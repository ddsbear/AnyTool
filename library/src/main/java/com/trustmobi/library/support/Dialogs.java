package com.trustmobi.library.support;
...
public class Dialogs {
    ...
    Dialogs.Builder buildAlert(final Activity context,
    ...
    public static @CheckResult
    Dialogs.Builder buildAlert(final Activity context, final CharSequence title,
    ...
    public static class Builder extends AlertDialog.Builder {
        ...
        public @CheckResult
        Builder withOkButton(final Runnable task) {
            setPositiveButton(android.R.string.ok, task == null ?
