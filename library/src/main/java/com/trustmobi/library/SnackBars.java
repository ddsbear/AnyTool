...
import com.trustmobi.library.utils.WebContent;
...
public class SnackBars {
    ...
    @CheckResult
    public static Additional lastsForever() {
    ...
    @CheckResult
    public static Additional whenSwiped(final Runnable callback) {
        return new Additional() {
            @Override
            public void invoke(Snackbar snackbar) {
    ...
    @CheckResult
    public static Additional withAction(final int label_res, final View.OnClickListener listener) {
        return new Additional() {
            @Override
            public void invoke(Snackbar snackbar) {
    ...
    @CheckResult
    public static Additional withAction(final CharSequence label, final View.OnClickListener listener) {
        return new Additional() {
            @Override
            public void invoke(Snackbar snackbar) {
    ...
    @CheckResult
    public static Additional withLink(final int text_res, final Uri uri) {
        return new Additional() {
            @Override
            public void invoke(Snackbar snackbar) {
                withLink(snackbar.getView().getContext().getText(text_res), uri).invoke(snackbar);
            }
        };
    }

    @CheckResult
    public static Additional withLink(final CharSequence text, final Uri uri) {
        return new Additional() {
            @Override
            public void invoke(final Snackbar snackbar) {
                ...
                snackbar.getView().addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
                    ...
                    @Override
                    public void onViewAttachedToWindow(final View snackbar_view) {
                        mConnection = WebContent.preload(snackbar_view.getContext(), uri,
                                new WebContent.OnSessionReadyListener() {
                                    @Override
                                    public void onSessionReady(final CustomTabsSession session) {
                                        snackbar.setAction(text, new View.OnClickListener() {
                                            @Override
                                            public void onClick(View v) {
